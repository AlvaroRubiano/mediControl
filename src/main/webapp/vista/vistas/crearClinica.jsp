<%-- 
    Document   : crearClinica
    Created on : 4/07/2025, 3:29:03 p. m.
            ...
            <div class="table-responsive">
                <table id="tablaActividades" class="table table-bordered table-striped table-hover" style="width:100%">
                    ...
                    <%  Conexion conexion = new Conexion();
                        ...
                        String consulta = "SELECT identificacion, nombre, direccion, ciudad.ciudad FROM cliente, ciudad WHERE cliente.idCiudad=ciudad.idCiudad";
                    ...
                    <div class="modal-body">
                        <div class="container">
                            <form action="../../CrearClinica" method="POST" class="row g-3">
                                ...
                                <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                                    <button type="submit" name="crearClinica" value="crearClinica" class="btn btn-primary">Crear</button>
                                </div>
                            </form>
                        </div>
