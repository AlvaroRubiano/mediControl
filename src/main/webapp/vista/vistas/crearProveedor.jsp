            ...
            <div class="table-responsive">
                <table id="tablaActividades" class="table table-bordered table-striped table-hover" style="width:100%">
                    ...
                    <%  Conexion conexion = new Conexion();
                        ...
                        String consulta = "SELECT identificacion, nombre, direccion, telefono, contacto, correo, ciudad.ciudad FROM proveedor, ciudad WHERE proveedor.idCiudad=ciudad.idCiudad";
                    ...
                    <tbody id="tabla" class="text-center">
                        <tr>
                            ...
                            <td class="text-center"><%= rs.getString("contacto")%></td>
                            ...
                            <td class="align-content-lg-center"><center>                        
                                <a href="modificarProveedor.jsp?id=<%= rs.getInt("identificacion")%>"><img src="../../publico/iconos/editar.png" width="30" height="24"></a>                       
                            </center></td>
                        </tr>
                        <% };%>
                    </tbody>                                
            ...
            <div class="modal-dialog modal-xl">
                <div class="modal-content">
                    <div class="modal-header">
                        <h1 class="modal-title fs-5" id="exampleModalLabel">Crear un nuevo proveedor</h1>
                        ...
                        <div class="container">
                            <form action="../../Proveedor" method="POST" class="row g-3">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="text"id="nombre" name="nombre" class="form-control"  title="Ingrese nombre del proveedor" required>
                                </div>
                                ...
                                <div class="col-md-3">
                                    ...
                                    <input type="text"id="telefono" name="telefono" class="form-control"  title="Teléfono de contacto" required="">
                                </div>                                
                                
                                <div class="col-md-4">
                                    <label for="inputContacto" class="form-label">Persona de contacto</label>
                                    <input type="text"id="contacto" name="contacto" class="form-control"  title="Persona de contacto" required="">
                                </div>
                                
                                <div class="col-md-5">
                                    <label for="inputCorreo" class="form-label">Correo</label>
                                    <input type="email"id="correo" name="correo" class="form-control"  title="Persona de contacto" required="">
                                </div>
                                ...
                                <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                                    <button type="submit" name="btnProveedor" value="crearProveedor" class="btn btn-primary">Crear</button>
                                </div>
                            </form>
                        </div>
