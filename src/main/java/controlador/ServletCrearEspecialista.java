 ...
 */
public class ServletCrearEspecialista extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String boton = request.getParameter("crearEspecialista");
        
        if(boton.equals("crearEspecialista")){
        
            ConsultaEspecialista consulta = new ConsultaEspecialista();
            
            Boolean resultado = consulta.crearEspecialista(registro, nombre, idCiudad);
