...
public class ServletPaciente extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String boton = request.getParameter("btnPaciente");
        ...
        switch (boton) {
            case "crearPaciente":
                ...
                identificacion = Long.parseLong(request.getParameter("cedula"));
                nombre = request.getParameter("nombre");
                ciudad = Integer.parseInt(request.getParameter("ciudad"));
                
                resultado = paciente.crearPaciente(identificacion, nombre, ciudad);
                
                if(resultado.equals(true)){
                    JOptionPane.showMessageDialog(null, "Paciente creado con éxito");
                    response.sendRedirect("vista/vistas/crearPaciente.jsp");
                }else{
