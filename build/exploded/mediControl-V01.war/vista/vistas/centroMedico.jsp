<%-- 
    Document   : centroMedico
    Created on : 18/09/2025, 3:54:36 p. m.
...
<html>
    ...
    <body>
        ...
        <div class="container">
            <center>
                <h4>Lista de Centros Médicos</h4>
            </center>                    
        </div>
            ...
            <div class="table-responsive">
                <table id="tablaActividades" class="table table-bordered table-striped table-hover" style="width:100%">
                    ...
                    <%  Conexion conexion = new Conexion();
                        ...
                        String consulta = "SELECT identificacion, nombre, direccion, ciudad.ciudad FROM centromedico, ciudad WHERE centromedico.idCiudad=ciudad.idCiudad";
            ...
            <div class="modal-dialog modal-xl">
                <div class="modal-content">
                    <div class="modal-header">
                        <h1 class="modal-title fs-5" id="exampleModalLabel">Crear nuevo centro médico</h1>
                    ...
                    <div class="modal-body">
                        <div class="container">
                            <form action="../../CrearClinica" method="POST" class="row g-3">
                                ...
                                <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                                    <button type="submit" name="crear" value="crearCentroMedico" class="btn btn-primary">Crear</button>
                                </div>
                            </form>
                        </div>
